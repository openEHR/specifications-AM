...
** an object node  absolute path terminating in an at-code (id-code), e.g. `"/data[at0001]/events[at0002]/data[at0003]/item[at0004]"` (`"/data[id2]/events[id3]/data[id1]/item[id4]"`);
* an at-code;
* an ac-code.
