...
Dates, times and date/times can also be constrained using intervals. Each date, time etc. in an interval may be a literal value of the corresponding type. Examples of such constraints:
