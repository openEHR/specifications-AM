...
[source, antlr-java]
--------
include::{openehr_adl_220_antlr_include}/adl/adl2.g4[]
--------
...
[source, antlr-java]
--------
include::{openehr_adl_220_antlr_include}/adl/cadl2.g4[]
--------
...
[source, antlr-java]
--------
include::{openehr_adl_220_antlr_include}/adl/cadl2_primitives.g4[]
--------
