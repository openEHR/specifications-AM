...
// override the Antlr include URI var so as to point to the correct release
:openehr_adl_antlr_include: {openehr_git_raw}/adl-antlr/ADL_2.0.6/src/main/antlr
:openehr_adl_antlr: {openehr_git}/adl-antlr/ADL_2.0.6/src/main/antlr

The normative specification of the ADL syntax is expressed in Antlr4 as a series of component grammars, shown below. This has been tested with the Antlr4.5 implementation available from http://www.antlr.org[Antlr.org]. The source files are available in the {openehr_adl_antlr}[ADL_2.0.6 tag of Adl-antlr^] at Github. Note that the ODIN grammar used in parts of an ADL archetype is not shown below, and can be found in the {openehr_odin}[openEHR ODIN specification^]..
...
[source, antlr-java]
--------
include::{openehr_adl_antlr_include}/adl.g4[]
--------
...
[source, antlr-java]
--------
include::{openehr_adl_antlr_include}/cadl.g4[] 
--------
...
[source, antlr-java]
--------
include::{openehr_adl_antlr_include}/cadl_primitives.g4[]
--------
...
[source, antlr-java]
--------
include::{openehr_adl_antlr_include}/adl_rules.g4[]
--------
...
[source, antlr-java]
--------
include::{openehr_adl_antlr_include}/adl_keywords.g4[]
--------
...
[source, antlr-java]
--------
include::{openehr_adl_antlr_include}/odin_values.g4[]
--------
...
[source, antlr-java]
--------
include::{openehr_adl_antlr_include}/base_patterns.g4[]
--------
