...
Special thanks to Prof David Ingram, head of CHIME, UCL, who provided a vision and collegial working environment ever since the days of GEHR (1992).
...
include::master05-rules.adoc[leveloffset=+1]
...
include::master11-templates.adoc[leveloffset=+1]
