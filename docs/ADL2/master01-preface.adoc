...
ADL2 was initially released with a new id-coded coding system using id-codes, at-codes and ac-codes.
...
When using the at-coded coding system, this ADL2.4 release is fully backwards compatible with openEHR data created based on ADL 1.4 archetypes but breaks compatibility with openEHR data created based on ADL 2.0 - ADL 2.3 archetypes.
