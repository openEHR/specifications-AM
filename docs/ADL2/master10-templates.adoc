...
[source, adl]
--------
archetype (archetype (adl_version=2.4.0; rm_release=1.0.3)
...
[source, adl]
--------
template (archetype (adl_version=2.4.0; rm_release=1.0.3)
...
[source, adl]
--------
operational_template (archetype (adl_version=2.4.0; rm_release=1.0.3; generated)
	openEHR-EHR-COMPOSITION.t_clinical_info_ds_sf.v1.0.0
...
[source, adl]
--------
operational_template (archetype (adl_version=2.4.0; rm_release=1.0.2; generated)
	openEHR-EHR-COMPOSITION.t_clinical_info_ds_sf.v1.0.0
