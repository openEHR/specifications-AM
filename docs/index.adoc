...
|http://www.openehr.org/releases/AM/{am_release}/UML/openEHR_UML-AM.mdzip[openEHR_UML-AM.mdzip]
|MagicDraw 18.5 UML file for AOM 2. Contains UML 2.5 standard XMI file.

|http://www.openehr.org/releases/AM/{am_release}/UML/openEHR_UML-AM-14.mdzip[openEHR_UML-AM-14.mdzip]
...
|http://www.openehr.org/releases/RM/Release-1.0.3/UML/openEHR_UML-RM.mdzip[openEHR_UML-RM.mdzip]
