...
4+^h|*AM Release 2.4.0*

|[[latest_issue]]1.4.6
|{spec_tickets}/SPECPR-378[SPECPR-378^]. Fix typos in AOM 1.4.
|P Pazos
...
|
|{spec_tickets}/SPECAM-82[SPECAM-82^]. Upgrade AOM1.4 model to use BASE, and to have regular package structure. Correct a UML error to move the invariant on `C_MULTIPLE_ATTRIBUTE` to `C_SINGLE_ATTRIBUTE`.
|T Beale
|14 Feb 2023
