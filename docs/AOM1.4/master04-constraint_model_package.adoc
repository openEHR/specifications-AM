...
include::{uml_export_dir}/AOM1.4/classes/{pkg}archetype_constraint.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_attribute.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_single_attribute.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_multiple_attribute.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}cardinality.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_object.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_defined_object.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_complex_object.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_primitive_object.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_domain_type.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}c_reference_object.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}archetype_slot.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}archetype_internal_ref.adoc[]
include::{uml_export_dir}/AOM1.4/classes/{pkg}constraint_ref.adoc[]
