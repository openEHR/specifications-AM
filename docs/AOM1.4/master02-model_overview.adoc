...
[.text-center]
.Package Overview
image::{uml_export_dir}/AOM1.4/diagrams/AOM-packages.svg[id=package_overview, align="center", width="70%"]
...
image::diagrams/archetype_parsing_process.png[id=archetype_parsing_process, align="center", width="70%"]
