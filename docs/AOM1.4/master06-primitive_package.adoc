...
image::{uml_export_dir}/AOM1.4/diagrams/AM-constraint_model.primitive.svg[id=constraint_model.primitive_package, align="center"]
...
include::{uml_export_dir}/AOM1.4/classes/c_primitive.adoc[]
include::{uml_export_dir}/AOM1.4/classes/c_boolean.adoc[]
include::{uml_export_dir}/AOM1.4/classes/c_string.adoc[]
include::{uml_export_dir}/AOM1.4/classes/c_integer.adoc[]
include::{uml_export_dir}/AOM1.4/classes/c_real.adoc[]
include::{uml_export_dir}/AOM1.4/classes/c_date.adoc[]
include::{uml_export_dir}/AOM1.4/classes/c_time.adoc[]
include::{uml_export_dir}/AOM1.4/classes/c_date_time.adoc[]
include::{uml_export_dir}/AOM1.4/classes/c_duration.adoc[]
