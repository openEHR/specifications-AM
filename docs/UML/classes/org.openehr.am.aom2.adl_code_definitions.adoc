...
h|*1..1*
|*At_code_leader*: `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^]{nbsp}={nbsp}"at"`
...
h|*1..1*
|*Specialisation_separator*: `link:/releases/BASE/{base_release}/foundation_types.html#_character_class[Character^]{nbsp}={nbsp}'.'`
...
h|*1..1*
|*Root_code_regex_pattern*: `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^]{nbsp}={nbsp}"^(id1&#124;at0000)(\.1)&#42;$"`
...
h|*1..1*
|*Primitive_node_id*: `link:/releases/BASE/{base_release}/foundation_types.html#_string_class[String^]{nbsp}={nbsp}"at9999"`
