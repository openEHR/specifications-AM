...
a|Regex pattern of the root at code of any archetype. Corresponds to codes of the form `at0000`, `at0000.1`, `at0000.1.1` etc. For at-coded ADL2 numbering starts with zero (i.e. at0000).
...
a|Regex pattern of the root id code of any archetype. Corresponds to codes of the form `id1`, `id1.1`, `id1.1.1` etc. For id-coded ADL2 numbering starts with one (i.e. id1).
