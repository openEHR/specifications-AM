...
h|*0..1 +
(redefined)*
|*constraint*: `link:/releases/BASE/{am_release}/foundation_types.html#_interval_class[Interval^]<link:/releases/BASE/{am_release}/foundation_types.html#_iso8601_date_class[Iso8601_date^]>`
...
h|*0..1 +
(redefined)*
|*default_value*: `link:/releases/BASE/{am_release}/foundation_types.html#_iso8601_date_class[Iso8601_date^]`
a|Default value set in a template, and present in an operational template. Generally limited to leaf and near-leaf nodes.

h|*0..1 +
(redefined)*
|*assumed_value*: `link:/releases/BASE/{am_release}/foundation_types.html#_iso8601_date_class[Iso8601_date^]`
