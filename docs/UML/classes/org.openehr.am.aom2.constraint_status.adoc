...
h|
|*required*: `link:/releases/BASE/{base_release}/foundation_types.html#_integer_class[Integer^]{nbsp}={nbsp}0`
a|Data item is required to formally satisfy `_constraint_`.

Enumeration value = 0.

h|
|*extensible*: `link:/releases/BASE/{base_release}/foundation_types.html#_integer_class[Integer^]{nbsp}={nbsp}1`
...
h|
|*preferred*: `link:/releases/BASE/{base_release}/foundation_types.html#_integer_class[Integer^]{nbsp}={nbsp}2`
...
h|
|*example*: `link:/releases/BASE/{base_release}/foundation_types.html#_integer_class[Integer^]{nbsp}={nbsp}3`
