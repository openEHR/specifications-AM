...
h|*1..1*
|*is_bag* (): `link:/releases/BASE/{base_release}/foundation_types.html#_boolean_class[Boolean^]`
a|True if the semantics of this cardinality represent a bag, i.e. unordered, non-unique membership.

h|*1..1*
|*is_list* (): `link:/releases/BASE/{base_release}/foundation_types.html#_boolean_class[Boolean^]`
a|True if the semantics of this cardinality represent a list, i.e. ordered, non-unique membership.

h|*1..1*
|*is_set* (): `link:/releases/BASE/{base_release}/foundation_types.html#_boolean_class[Boolean^]`
a|True if the semantics of this cardinality represent a bag, i.e. unordered, non-unique membership.
|===
