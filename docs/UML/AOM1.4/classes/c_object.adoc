...
h|*1..1*
|*rm_type_name*: `link:/releases/BASE/1.4/assumed_types.html#_string_class[String^]`
a|Reference model type that this node corresponds to.

h|*1..1*
|*occurrences*: `link:/releases/BASE/1.4/structure.html#_interval_class[Interval^]<link:/releases/BASE/1.4/assumed_types.html#_integer_class[Integer^]>`
...
h|*1..1*
|*node_id*: `link:/releases/BASE/1.4/assumed_types.html#_string_class[String^]`
