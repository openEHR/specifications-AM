...
h|*0..1*
|*includes*: `link:/releases/BASE/1.4/structure.html#_list_class[List^]<<<_assertion_class,ASSERTION>>>`
a|List of constraints defining other archetypes that could be included at this point.

h|*0..1*
|*excludes*: `link:/releases/BASE/1.4/structure.html#_list_class[List^]<<<_assertion_class,ASSERTION>>>`
