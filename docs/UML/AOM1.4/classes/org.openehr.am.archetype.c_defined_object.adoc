...
h|*0..1*
|*assumed_value*: `link:/releases/BASE/{base_release}/base_types.html#_any_class[Any^]`
...
(abstract)*
|*valid_value* ( +
a_value: `link:/releases/BASE/{base_release}/base_types.html#_any_class[Any^][1]` +
): `Boolean`
a|True if a_value is valid with respect to constraint expressed in concrete instance of this type.

h|*1..1 +
(abstract)*
|*prototype_value* (): `link:/releases/BASE/{base_release}/base_types.html#_any_class[Any^]`
...
h|*0..1 +
(abstract)*
|*default_value* (): `link:/releases/BASE/{base_release}/base_types.html#_any_class[Any^]`
