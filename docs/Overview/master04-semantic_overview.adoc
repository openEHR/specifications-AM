...
The IS-A hierarchy is available in archetype tools such as the {openehr_awb}[openEHR ADL Workbench], as shown in the figure <<archetypes_is_a_hierarchy>>.
