...
image::{uml_export_dir}/diagrams/AM-p_aom2-upper.png[id=P_AOM_upper, align="center"]

[.text-center]
.am.p_aom2 Package - Serialisation AOM (lower)
image::{uml_export_dir}/diagrams/AM-p_aom2-lower.png[id=P_AOM_lower, align="center"]
