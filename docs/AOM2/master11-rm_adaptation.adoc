...
include::{uml_export_dir}/classes/{pkg}aom_profile.adoc[]
include::{uml_export_dir}/classes/{pkg}aom_type_mapping.adoc[]
include::{uml_export_dir}/classes/{pkg}aom_property_mapping.adoc[]
