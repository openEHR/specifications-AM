...
The AOM `rules` package adds two classes based on classes in the `LANG::org.openehr.bmm.expressions` package described in the {openehr_bmm}[BMM Expression Model^]. The package is shown below.
