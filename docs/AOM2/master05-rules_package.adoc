...
The AOM `rules` package adds two classes based on classes in the `org.openehr.expressions` package described in the {openehr_el}[openEHR Expression Language Object Model (ELOM)]. The package is shown below.
