...
|[[latest_issue]]2.3.0
|{spec_tickets}/SPECAM-76[SPECAM-76^]. Correct VSONCO rule for redefinition of nodes with multiple occurrences (addresses problem {spec_tickets}/SPECPR-374[SPECPR-374^]).
|P Bos, +
 S Garde, +
 I McNicoll, +
 P Pazos, +
