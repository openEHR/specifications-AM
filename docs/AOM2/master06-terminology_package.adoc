...
[.text-center]
.Terminology Package
image::{uml_diagrams_uri}/AOM-terminology.svg[id=terminology_package, align="center"]
...
image::{diagrams_uri}/terminology_instance_structure.png[id=terminology_instance, align="center"]
