...
image::{uml_export_dir}/diagrams/AM-aom2.terminology.svg[id=terminology_package, align="center"]
...
include::{uml_export_dir}/classes/archetype_terminology.adoc[]
include::{uml_export_dir}/classes/terminology_relation.adoc[]
include::{uml_export_dir}/classes/value_set.adoc[]
include::{uml_export_dir}/classes/archetype_term.adoc[]
