...
This may be implemented by automatic means, or alternatively via tools that enable some configuration of which type names are considered equivalent in Refeence Models in general, or even on a per-RM basis.
