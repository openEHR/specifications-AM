...
image::{uml_diagrams_uri}/AM-aom2.constraint_model-top.svg[id=constraint_model_top, align="center"]
...
image::{uml_diagrams_uri}/AM-aom2.constraint_model-bottom.svg[id=constraint_model_bottom, align="center"]
...
A way of configuring this on a per-RM basis is described in the <<RM Primitive Type Equivalences>> below.
