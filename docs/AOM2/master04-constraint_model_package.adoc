...
The tuple constraint type replaces all domain-specific constraint types defined in ADL/AOM 1.4 <<openehr_am_adl14>>, including `C_DV_QUANTITY` and `C_DV_ORDINAL`.
