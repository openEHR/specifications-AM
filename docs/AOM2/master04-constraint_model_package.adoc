...
image::{uml_diagrams_uri}/AOM-constraint_model-top.svg[id=constraint_model_top, align="center"]
...
image::{uml_diagrams_uri}/AOM-constraint_model-bottom.svg[id=constraint_model_bottom, align="center"]
...
image::{uml_diagrams_uri}/AOM-constraint_model-tuple.svg[id=tuple_constraint_model, align="center"]
...
image::{uml_diagrams_uri}/AOM-ordinal_tuple_example.svg[id=ordinal_tuple_example, align="center"]

[.text-center]
.Tuple Constraint Example Data
image::{diagrams_uri}/tuple_example_data.png[id=tuple_constraint_example_data, align="center"]
...
image::{diagrams_uri}/c_object_substitutions.png[id=c_object_substitutions, align="center"]
