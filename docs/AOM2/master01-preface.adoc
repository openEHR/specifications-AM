...
* Additional attribute `title` was added to the `RESOURCE_DESCRIPTION` class. It is recommended in ADL 1.4 → ADL2.4 conversion to populate this new attribute with the "Template ID" (or similar) of ADL 1.4 templates.
