...
This specification is in the {spec_status} state. The development version of this document can be found at {openehr_am_aom2}[{openehr_domain}/releases/AM/latest/AOM2.html].
