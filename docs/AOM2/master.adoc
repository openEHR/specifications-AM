...
image::diagrams/block_diagram.png["openEHR components",align="center",scaledwidth="60%"]
 
...
[.text-center]
.Archetype Package
image::uml_diagrams/AOM-archetype.svg[id=archetype_package, align="center"]
...
image::diagrams/archetype_hrid_structure.png[id=archetype_hrid_structure, align="center",scaledwidth="80%"]
...
[.text-center]
.Governance Meta-data
image::images/metadata_governance.png[id=metadata_governance, align="center", scaledwidth="80%"]
...
[.text-center]
.Authoring Meta-data
image::images/metadata_authoring.png[id=metadata_authoring, align="center", scaledwidth="80%"]
...
[.text-center]
.Descriptive Meta-data
image::images/metadata_details.png[id=metadata_descriptive, align="center", scaledwidth="80%"]
...
image::uml_diagrams/AOM-source_archetype_structure.svg[id=source_archetype_structure, align="center", scaledwidth="80%"]
...
image::uml_diagrams/AOM-source_template_structure.svg[id=source_template_structure, align="center", scaledwidth="80%"]
...
image::uml_diagrams/AOM-operational_template_structure.svg[id=operational_template_structure, align="center", scaledwidth="80%"]
...
image::uml_diagrams/AOM-constraint_model-top.svg[id=constraint_model_top, align="center"]
...
image::uml_diagrams/AOM-constraint_model-bottom.svg[id=constraint_model_bottom, align="center"]
...
image::diagrams/c_attributes.png[id=c_attributes, align="center"]
...
image::diagrams/enumerated_type_constraint.png[id=enumerated_constraint, align="center"]
...
image::uml_diagrams/AOM-constraint_model-tuple.svg[id=tuple_constraint_model, align="center"]
...
image::uml_diagrams/AOM-ordinal_tuple_example.svg[id=ordinal_tuple_example, align="center"]
...
[.text-center]
.Terminology Package
image::uml_diagrams/AOM-terminology.svg[id=terminology_package, align="center"]
...
image::diagrams/terminology_instance_structure.png[id=terminology_instance, align="center"]
