...
image::{openehr_base_releases}/docs/UML/diagrams/BASE-foundation_types-leaf_types.svg[id=base_types_leaf_types, align="center"]

[.text-center]
.`base.foundation_types.interval` Package
image::{openehr_base_releases}/docs/UML/diagrams/BASE-foundation_types.interval.svg[id=base_types_structure_types, align="center"]
...
image::{openehr_base_releases}/docs/UML/diagrams/BASE-base_types.definitions.svg[id=base_types_definitions, align="center"]
