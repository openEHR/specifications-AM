...
image::{uml_export_dir}/diagrams/BASE-base_types.structures.svg[id=base_types_structure_types, align="center"]

[.text-center]
.base_types.structures Package
image::{uml_export_dir}/diagrams/BASE-base_types.definitions.svg[id=base_types_definitions, align="center"]
