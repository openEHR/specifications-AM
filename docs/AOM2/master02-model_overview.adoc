...
image::{openehr_base_releases_loc}/docs/UML/diagrams/BASE-foundation_types-leaf_types.svg[id=base_types_leaf_types, align="center"]

[.text-center]
.`base.foundation_types.interval` Package
image::{openehr_base_releases_loc}/docs/UML/diagrams/BASE-foundation_types.interval.svg[id=base_types_structure_types, align="center"]
...
image::{openehr_base_releases_loc}/docs/UML/diagrams/BASE-base_types.definitions.svg[id=base_types_definitions, align="center"]
...
The Archetype Object Model is defined by the package `am.aom2` and subordinate packages, as illustrated in Figure <<aom_package_overview>>.

[.text-center]
.Package Overview
image::{uml_export_dir}/diagrams/AM-packages.svg[id=aom_package_overview, align="center"]
...
[.text-center]
.Definition Package
image::{uml_export_dir}/diagrams/AM-aom2.definitions.svg[id=definition_package, align="center"]
