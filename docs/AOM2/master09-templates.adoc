...
* slot-filling - achieved by specialisation, as described in the http://www.openehr.org/releases/AM/latest/ADL2.html[ADL specification];
...
image::{uml_export_dir}/diagrams/AOM-template_example_1.png[id=AOM-template_example_1, align="center"]
