...
image::diagrams/archetype_hrid_structure.svg[id=archetype_hrid_structure, align="center",width="80%"]
...
[.text-center]
.Governance Meta-data
image::images/metadata_governance.png[id=metadata_governance, align="center", width="80%"]
...
[.text-center]
.Descriptive Meta-data
image::images/metadata_details.png[id=metadata_descriptive, align="center"]
...
image::{uml_export_dir}/diagrams/AM-source_archetype_structure.svg[id=source_archetype_structure, align="center", width="60%"]
...
image::{uml_export_dir}/diagrams/AM-source_template_structure.svg[id=source_template_structure, align="center", width="80%"]
...
image::{uml_export_dir}/diagrams/AM-operational_template_structure.svg[id=operational_template_structure, align="center", width="80%"]
