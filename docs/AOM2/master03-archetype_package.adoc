...
[.text-center]
.Archetype Package
image::{uml_diagrams_uri}/AOM-archetype.svg[id=archetype_package, align="center"]
...
image::{diagrams_uri}/archetype_hrid_structure.png[id=archetype_hrid_structure, align="center",width="80%"]
...
image::{uml_diagrams_uri}/AOM-source_archetype_structure.svg[id=source_archetype_structure, align="center", width="60%"]
...
image::{uml_diagrams_uri}/AOM-source_template_structure.svg[id=source_template_structure, align="center", width="80%"]
...
image::{uml_diagrams_uri}/AOM-operational_template_structure.svg[id=operational_template_structure, align="center", width="80%"]
