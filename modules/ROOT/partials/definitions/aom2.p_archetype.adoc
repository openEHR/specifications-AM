...
h|*1..1*
|*archetype_id*: `xref:{class_p_archetype_hrid}[P_ARCHETYPE_HRID]`
...
h|*1..1*
|*definition*: `xref:{class_p_c_complex_object}[P_C_COMPLEX_OBJECT]`
a|Root node of the definition of this archetype.

h|*1..1*
|*terminology*: `xref:{class_p_archetype_terminology}[P_ARCHETYPE_TERMINOLOGY]`
a|The terminology of the archetype.

h|*0..1*
|*rules*: `xref:{class_list}[List]<xref:{class_el_boolean_expression}[EL_BOOLEAN_EXPRESSION]>`
