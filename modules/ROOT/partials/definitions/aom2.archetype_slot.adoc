...
h|*0..1*
|*includes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<link:/classes/ASSERTION[ASSERTION] >`
...
h|*0..1*
|*excludes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<link:/classes/ASSERTION[ASSERTION] >`
