...
h|*Inherit*
2+|`xref:AM:p_aom2:archetype_package.adoc#_p_archetype_class[P_ARCHETYPE]`, `xref:BASE:resource:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE]`, `xref:AM:p_aom2:archetype_package.adoc#_p_authored_resource_class[P_AUTHORED_RESOURCE]`
