...
h|*Inherit*
2+|`xref:{class_p_archetype}[P_ARCHETYPE]`, `xref:{class_authored_resource}[AUTHORED_RESOURCE]`, `xref:{class_p_authored_resource}[P_AUTHORED_RESOURCE]`
...
h|*1..1*
|*rm_release*: `xref:{class_string}[String]`
...
h|*1..1*
|*is_generated*: `xref:{class_boolean}[Boolean]`
...
h|*1..1*
|*other_meta_data*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_string}[String]>`
a|
|===
