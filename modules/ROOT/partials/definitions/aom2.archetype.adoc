...
h|*1..1*
|*archetype_id*: `xref:AM:AOM2:archetype_package.adoc#_archetype_hrid_class[ARCHETYPE_HRID]`
...
h|*1..1*
|*definition*: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_complex_object_class[C_COMPLEX_OBJECT]`
a|Root node of the definition of this archetype.

h|*1..1*
|*terminology*: `xref:AM:AOM2:terminology_package.adoc#_archetype_terminology_class[ARCHETYPE_TERMINOLOGY]`
a|The terminology of the archetype.

h|*0..1*
|*rules*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:beom:core_package.adoc#_statement_set_class[STATEMENT_SET]>`
...
h|*0..1*
|*rm_overlay*: `xref:AM:AOM2:rm_adaptation.adoc#_rm_overlay_class[RM_OVERLAY]`
a|
