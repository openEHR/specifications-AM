...
h|*0..1*
|*parent_archetype_id*: `xref:{class_string}[String]`
...
h|*1..1*
|*archetype_id*: `xref:{class_archetype_hrid}[ARCHETYPE_HRID]`
...
h|*1..1*
|*terminology*: `xref:{class_archetype_terminology}[ARCHETYPE_TERMINOLOGY]`
a|The terminology of the archetype.

h|*0..1*
|*rules*: `xref:{class_list}[List]<link:/classes/STATEMENT_SET[STATEMENT_SET] >`
...
h|*0..1*
|*rm_overlay*: `xref:{class_rm_overlay}[RM_OVERLAY]`
a|
