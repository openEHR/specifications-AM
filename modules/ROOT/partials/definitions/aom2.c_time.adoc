...
h|*0..1 +
(redefined)*
|*constraint*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:interval.adoc#_interval_class[Interval]<xref:BASE:foundation_types:time_types.adoc#_iso8601_time_class[Iso8601_time]>>`
...
h|*0..1 +
(effected)*
|*default_value*: `xref:BASE:foundation_types:time_types.adoc#_iso8601_time_class[Iso8601_time]`
a|Default value set in a template, and present in an operational template. Generally limited to leaf and near-leaf nodes.

h|*0..1 +
(effected)*
|*assumed_value*: `xref:BASE:foundation_types:time_types.adoc#_iso8601_time_class[Iso8601_time]`
