...
h|*Inherit*
2+|`xref:LANG:beom:core_package.adoc#_expr_value_ref_class[EXPR_VALUE_REF]`
...
h|*1..1 +
(redefined)*
|*item*: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_archetype_constraint_class[ARCHETYPE_CONSTRAINT]`
a|
|===
