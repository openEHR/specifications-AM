...
h|*1..1*
|*owner_archetype*: `xref:{class_archetype}[ARCHETYPE]`
...
h|*0..1*
|*terminology_extracts*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_archetype_term}[ARCHETYPE_TERM]>>`
...
h|*1..1*
|*node_codes* (): `xref:{class_list}[List]<xref:{class_string}[String]>`
...
h|*0..1*
|*value_codes* (): `xref:{class_list}[List]<xref:{class_string}[String]>`
...
h|*0..1*
|*value_set_codes* (): `xref:{class_list}[List]<xref:{class_string}[String]>`
...
h|*1..1*
|*languages_available* (): `xref:{class_list}[List]<xref:{class_string}[String]>`
