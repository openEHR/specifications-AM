...
h|*0..1*
|*aom_rm_type_mappings*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:AM:AOM2:rm_adaptation.adoc#_aom_type_mapping_class[AOM_TYPE_MAPPING]>`
