...
h|*0..1*
|*archetype_data_value_parent_class*: `xref:{class_string}[String]`
...
h|*0..1*
|*aom_rm_type_mappings*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_aom_type_mapping}[AOM_TYPE_MAPPING]>`
...
h|*0..1*
|*archetype_visualise_descendants_of*: `xref:{class_string}[String]`
...
h|*0..1*
|*aom_rm_type_substitutions*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_string}[String]>`
...
h|*0..1*
|*aom_lifecycle_mappings*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_string}[String]>`
...
h|*0..1*
|*rm_primitive_type_equivalences*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_string}[String]>`
