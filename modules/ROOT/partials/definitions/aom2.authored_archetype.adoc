...
h|*Inherit*
2+|`xref:AM:AOM2:archetype_package.adoc#_archetype_class[ARCHETYPE]`, `xref:BASE:resource:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE]`
...
h|*1..1*
|*build_uid*: `xref:BASE:base_types:identification_package.adoc#_uuid_class[UUID]`
