...
h|*Inherit*
2+|`xref:{class_p_authored_archetype}[P_AUTHORED_ARCHETYPE]`
...
h|*0..1*
|*component_terminologies*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_p_archetype_terminology}[P_ARCHETYPE_TERMINOLOGY]>`
