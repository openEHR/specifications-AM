...
h|*1..1*
|*archetype_id*: `xref:AM:p_aom2:archetype_package.adoc#_p_archetype_hrid_class[P_ARCHETYPE_HRID]`
...
h|*1..1*
|*definition*: `xref:AM:p_aom2:constraint_model_package.adoc#_p_c_complex_object_class[P_C_COMPLEX_OBJECT]`
a|Root node of the definition of this archetype.

h|*1..1*
|*terminology*: `xref:AM:p_aom2:terminology_package.adoc#_p_archetype_terminology_class[P_ARCHETYPE_TERMINOLOGY]`
