...
h|*0..1 +
(redefined)*
|*constraint*: `xref:{class_list}[List]<xref:{class_interval}[Interval]<xref:{class_iso8601_date_time}[Iso8601_date_time]>>`
...
h|*0..1 +
(effected)*
|*default_value*: `xref:{class_iso8601_date_time}[Iso8601_date_time]`
a|Default value set in a template, and present in an operational template. Generally limited to leaf and near-leaf nodes.

h|*0..1 +
(effected)*
|*assumed_value*: `xref:{class_iso8601_date_time}[Iso8601_date_time]`
...
h|*1..1*
|*minute_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]`
a|Validity of minute in constrained time.

h|*1..1*
|*second_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]`
a|Validity of second in constrained time.

h|*1..1*
|*millisecond_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]`
a|Validity of millisecond in constrained time.

h|*1..1*
|*timezone_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]`
