...
h|*0..1*
|*hour_validity*: `xref:{class_validity_kind}[VALIDITY_KIND]`
...
h|*0..1*
|*range*: `xref:{class_interval}[Interval]<xref:{class_iso8601_date_time}[Iso8601_date_time]>`
...
h|*1..1*
|*validity_is_range* (): `xref:{class_boolean}[Boolean]`
