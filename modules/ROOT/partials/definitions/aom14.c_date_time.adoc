...
h|*0..1*
|*hour_validity*: `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]`
...
h|*0..1*
|*range*: `xref:BASE:foundation_types:interval.adoc#_interval_class[Interval]<xref:BASE:foundation_types:time_types.adoc#_iso8601_date_time_class[Iso8601_date_time]>`
...
h|*1..1*
|*validity_is_range* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
