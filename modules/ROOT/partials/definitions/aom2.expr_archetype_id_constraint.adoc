...
h|*Inherit*
2+|`xref:AM:AOM2:rules_package.adoc#_expr_constraint_class[EXPR_CONSTRAINT]`
...
h|*1..1 +
(redefined)*
|*item*: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_string_class[C_STRING]`
