...
h|*Inherit*
2+|`xref:AM:aom2:persistence_package.adoc#_p_archetype_constraint_class[P_ARCHETYPE_CONSTRAINT]`
...
h|*0..1*
|*children*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:aom2:persistence_package.adoc#_p_c_object_class[P_C_OBJECT]>`
