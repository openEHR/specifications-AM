...
h|*1..1*
|*Root_code_regex_pattern*: `xref:{class_string}[String]{nbsp}={nbsp}"^(id1&#124;at0000)(\.1)&#42;$"`
...
h|*1..1*
|*Primitive_node_id*: `xref:{class_string}[String]{nbsp}={nbsp}"at9999"`
