...
h|*0..1*
|*rm_visibility*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:AM:AOM2:rm_adaptation.adoc#_rm_attribute_visibility_class[RM_ATTRIBUTE_VISIBILITY]>`
