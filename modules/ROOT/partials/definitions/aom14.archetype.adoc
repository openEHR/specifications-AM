...
h|*Inherit*
2+|`xref:BASE:resource:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE]`
...
h|*1..1*
|*definition*: `xref:AM:AOM1.4:archetype_package.adoc#_c_complex_object_class[C_COMPLEX_OBJECT]`
a|Root node of the definition of this archetype.

h|*1..1*
|*ontology*: `xref:AM:AOM1.4:archetype_package.adoc#_archetype_ontology_class[ARCHETYPE_ONTOLOGY]`
...
h|*1..1*
|*archetype_id*: `xref:BASE:base_types:identification_package.adoc#_archetype_id_class[ARCHETYPE_ID]`
...
h|*1..1*
|*concept*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|The normative meaning of the archetype as a whole, expressed as a local archetype code, typically “at0000”.

h|*0..1*
|*parent_archetype_id*: `xref:BASE:base_types:identification_package.adoc#_archetype_id_class[ARCHETYPE_ID]`
a|Identifier of the specialisation parent of this archetype.

h|*0..1*
|*invariants*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:AOM1.4:archetype_package.adoc#_assertion_class[ASSERTION]>`
...
h|*1..1*
|*physical_paths* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>`
...
h|*1..1*
|*node_ids_valid* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
a|True if every node_id found on a C_OBJECT node is found in ontology.term_codes.

h|*0..1*
|*previous_version* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Version of predecessor archetype of this archetype, if any.

h|*1..1*
|*internal_references_valid* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
a|True if every ARCHETYPE_INTERNAL_REF. target_path refers to a legitimate node in the archetype definition.

h|*1..1*
|*constraint_references_valid* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*short_concept_name* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|The short concept name of the archetype extracted from the archetype_id.

h|*1..1*
|*version* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|
