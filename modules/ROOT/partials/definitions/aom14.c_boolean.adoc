...
h|*1..1*
|*true_valid*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
a|True if the value True is allowed.

h|*1..1*
|*false_valid*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
