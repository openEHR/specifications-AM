...
h|*0..1 +
(effected)*
|*default_value*: `xref:BASE:foundation_types:time_types.adoc#_iso8601_date_class[Iso8601_date]`
a|Default value set in a template, and present in an operational template. Generally limited to leaf and near-leaf nodes.

h|*0..1 +
(effected)*
|*assumed_value*: `xref:BASE:foundation_types:time_types.adoc#_iso8601_date_class[Iso8601_date]`
