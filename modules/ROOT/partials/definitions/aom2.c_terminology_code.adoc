...
h|*1..1 +
(redefined)*
|*constraint*: `xref:{class_string}[String]`
...
h|*0..1 +
(redefined)*
|*assumed_value*: `xref:{class_terminology_code}[Terminology_code]`
a|Assumed Terminology code value.

h|*1..1 +
(redefined)*
|*default_value*: `xref:{class_terminology_code}[Terminology_code]`
a|
...
h|*0..1*
|*value_set_expanded* (): `xref:{class_list}[List]<xref:{class_string}[String]>`
...
h|*0..1*
|*value_set_substituted* (): `xref:{class_list}[List]<xref:{class_uri}[Uri]>`
...
h|*0..1*
|*value_set_resolved* (): `xref:{class_list}[List]<xref:{class_terminology_code}[Terminology_code]>`
...
h|*1..1 +
(effected)*
|*prototype_value* (): `xref:{class_terminology_code}[Terminology_code]`
