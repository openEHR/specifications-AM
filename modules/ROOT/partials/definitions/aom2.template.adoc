...
h|*0..1*
|*overlays*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:AOM2:archetype_package.adoc#_template_overlay_class[TEMPLATE_OVERLAY]>`
