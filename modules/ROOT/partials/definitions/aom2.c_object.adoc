...
h|*0..1*
|*occurrences*: `xref:BASE:foundation_types:interval.adoc#_multiplicity_interval_class[Multiplicity_interval]`
...
h|*0..1*
|*sibling_order*: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_sibling_order_class[SIBLING_ORDER]`
...
h|*1..1*
|*effective_occurrences* (): `xref:BASE:foundation_types:interval.adoc#_multiplicity_interval_class[Multiplicity_interval]`
a|
