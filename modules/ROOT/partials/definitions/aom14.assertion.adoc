...
h|*1..1*
|*expression*: `xref:AM:AOM1.4:archetype_package.adoc#_expr_item_class[EXPR_ITEM]`
a|Root of expression tree.

h|*0..1*
|*variables*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:AOM1.4:archetype_package.adoc#_assertion_variable_class[ASSERTION_VARIABLE]>`
