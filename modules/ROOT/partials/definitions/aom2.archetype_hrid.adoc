...
h|*1..1*
|*semantic_id* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|The 'interface' form of the HRID, i.e. down to the major version.

h|*1..1*
|*physical_id* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
h|*1..1*
|*major_version* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Major version of this archetype, extracted from `_release_version_`.

h|*1..1*
|*minor_version* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Minor version of this archetype, extracted from `_release_version_`.

h|*1..1*
|*patch_version* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
