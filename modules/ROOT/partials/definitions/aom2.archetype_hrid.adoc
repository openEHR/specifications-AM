...
h|*0..1*
|*namespace*: `xref:{class_string}[String]`
a|Reverse domain name namespace identifier.

h|*1..1*
|*rm_publisher*: `xref:{class_string}[String]`
a|Name of the Reference Model publisher.

h|*1..1*
|*rm_package*: `xref:{class_string}[String]`
...
h|*1..1*
|*build_count*: `xref:{class_string}[String]`
...
h|*1..1*
|*semantic_id* (): `xref:{class_string}[String]`
a|The 'interface' form of the HRID, i.e. down to the major version.

h|*1..1*
|*physical_id* (): `xref:{class_string}[String]`
