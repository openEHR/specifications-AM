...
2+|Inherits: xref:{class_expr_value}[EXPR_VALUE], xref:{class_expression}[EXPRESSION], xref:{class_expr_leaf}[EXPR_LEAF], xref:{class_expr_constraint}[EXPR_CONSTRAINT]
