...
|*default_value*: `xref:{class_boolean}[Boolean]` [1..1]
a|Default Boolean value.

|*assumed_value*: `xref:{class_boolean}[Boolean]` [0..1]
...
|*constraint*: `xref:{class_list}[List]<xref:{class_boolean}[Boolean]>` [0..1]
...
|*prototype_value* (): `xref:{class_boolean}[Boolean]` [1..1]
...
|*c_value_conforms_to* ( +
other: `xref:{class_c_boolean}[C_BOOLEAN][1]` +
): `xref:{class_boolean}[Boolean]` [1..1]
