...
|*default_value*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [0..1]
...
|*prototype_value* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
...
|*c_value_conforms_to* ( +
other: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_boolean_class[C_BOOLEAN][1]` +
): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
