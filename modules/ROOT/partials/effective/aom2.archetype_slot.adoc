...
2+|Inherits: xref:AM:AOM2:model_overview.adoc#_adl_code_definitions_class[ADL_CODE_DEFINITIONS], xref:AM:AOM2:constraint_model-class_definitions.adoc#_archetype_constraint_class[ARCHETYPE_CONSTRAINT], xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_object_class[C_OBJECT]
...
|*includes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:beom:core_package.adoc#_assertion_class[ASSERTION]>` [0..1]
...
|*excludes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:beom:core_package.adoc#_assertion_class[ASSERTION]>` [0..1]
...
|*any_allowed* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
