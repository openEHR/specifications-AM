...
|*includes*: `xref:{class_list}[List]<link:/classes/ASSERTION[ASSERTION] >` [0..1]
...
|*excludes*: `xref:{class_list}[List]<link:/classes/ASSERTION[ASSERTION] >` [0..1]
...
|*any_allowed* (): `xref:{class_boolean}[Boolean]` [1..1]
