...
2+|Inherits: xref:AM:AOM2:model_overview.adoc#_adl_code_definitions_class[ADL_CODE_DEFINITIONS], xref:AM:AOM2:constraint_model-class_definitions.adoc#_archetype_constraint_class[ARCHETYPE_CONSTRAINT], xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_object_class[C_OBJECT], xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_defined_object_class[C_DEFINED_OBJECT], xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_complex_object_class[C_COMPLEX_OBJECT]
...
|*attributes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_attribute_class[C_ATTRIBUTE]>` [0..1]
a|List of constraints on attributes of the reference model type represented by this object. +
_Inherited from xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_complex_object_class[C_COMPLEX_OBJECT]_

|*attribute_tuples*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_attribute_tuple_class[C_ATTRIBUTE_TUPLE]>` [0..1]
