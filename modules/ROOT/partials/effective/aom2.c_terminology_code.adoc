...
|*default_value*: `xref:BASE:foundation_types:terminology.adoc#_terminology_code_class[Terminology_code]` [0..1]
a|
...
|*constraint_status*: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_constraint_status_enumeration[CONSTRAINT_STATUS]` [0..1]
...
|*any_allowed* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` +
 +
__Post__: `Result := constraint.is_empty` [1..1]
a|True if `_constraint_` is empty.

|*valid_value* ( +
a_value: `xref:BASE:foundation_types:terminology.adoc#_terminology_code_class[Terminology_code][1]` +
): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
a|True if a `_value_` is valid with respect to constraint expressed in concrete instance of this type.

|*prototype_value* (): `xref:BASE:foundation_types:terminology.adoc#_terminology_code_class[Terminology_code]` [1..1]
...
|*c_value_conforms_to* ( +
other: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_terminology_code_class[C_TERMINOLOGY_CODE][1]` +
): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
...
|*constraint_required* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
...
|*effective_constraint_status* (): `xref:BASE:foundation_types:primitive_types.adoc#_integer_class[Integer]` [1..1]
...
|*value_set_expanded* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>` [0..1]
...
|*value_set_substituted* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_uri_class[Uri]>` [0..1]
...
|*value_set_resolved* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:terminology.adoc#_terminology_code_class[Terminology_code]>` [0..1]
