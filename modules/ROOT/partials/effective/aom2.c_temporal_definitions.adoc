...
|*valid_date_constraint_patterns*: `xref:{class_list}[List]<xref:{class_string}[String]>` [1..1]
...
|*valid_date_constraint_replacements*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_list}[List]<xref:{class_string}[String]>>` [1..1]
...
|*valid_time_constraint_patterns*: `xref:{class_list}[List]<xref:{class_string}[String]>` [1..1]
...
|*valid_time_constraint_replacements*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_list}[List]<xref:{class_string}[String]>>` [1..1]
...
|*valid_date_time_constraint_patterns*: `xref:{class_list}[List]<xref:{class_string}[String]>` [1..1]
...
|*valid_date_time_constraint_replacements*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_list}[List]<xref:{class_string}[String]>>` [1..1]
...
a_dur: `xref:{class_string}[String][1]`, +
other_dur: `xref:{class_string}[String][1]` +
