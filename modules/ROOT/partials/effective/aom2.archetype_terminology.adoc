...
|*concept_code*: `xref:{class_string}[String]` [1..1]
...
|*owner_archetype*: `xref:{class_archetype}[ARCHETYPE]` [1..1]
...
|*node_codes* (): `xref:{class_list}[List]<xref:{class_string}[String]>` [1..1]
...
|*value_codes* (): `xref:{class_list}[List]<xref:{class_string}[String]>` [0..1]
...
|*value_set_codes* (): `xref:{class_list}[List]<xref:{class_string}[String]>` [0..1]
...
|*terminologies_available* (): `xref:{class_list}[List]<xref:{class_string}[String]>` [1..1]
