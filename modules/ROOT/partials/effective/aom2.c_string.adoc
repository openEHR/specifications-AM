...
|*default_value*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [0..1]
...
|*constraint*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>` [0..1]
...
|*any_allowed* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` +
 +
__Post__: `Result = constraint.is_empty or else constraint.count = 1 and constraint.first.is_equal (Regex_any_string)` [1..1]
...
|*prototype_value* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [1..1]
a|
...
|*c_value_conforms_to* ( +
other: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_string_class[C_STRING][1]` +
): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
