...
|*default_value*: `xref:BASE:foundation_types:primitive_types.adoc#_integer_class[Integer]` [0..1]
...
|*constraint*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:interval.adoc#_interval_class[Interval]<xref:BASE:foundation_types:primitive_types.adoc#_integer_class[Integer]>>` [0..1]
...
_Inherited from xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_ordered_class[C_ORDERED]_
