...
|*rules*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<link:/classes/STATEMENT[STATEMENT] >` [0..1]
...
|*component_terminologies*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:AM:AOM2:terminology_package.adoc#_archetype_terminology_class[ARCHETYPE_TERMINOLOGY]>` [0..1]
...
|*terminology_extracts*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:AM:AOM2:terminology_package.adoc#_archetype_terminology_class[ARCHETYPE_TERMINOLOGY]>` [0..1]
...
an_id: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String][1]` +
 ...
 +
__Inv_is_specialised__: `is_specialised` [1..1]
a|
