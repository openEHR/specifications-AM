...
2+|Inherits: xref:{class_p_archetype}[P_ARCHETYPE], xref:{class_authored_resource}[AUTHORED_RESOURCE], xref:{class_p_authored_resource}[P_AUTHORED_RESOURCE], xref:{class_p_authored_archetype}[P_AUTHORED_ARCHETYPE]

2+h|*Attributes*

|*parent_archetype_id*: `xref:{class_string}[String]` [0..1]
a|Identifier of the specialisation parent of this archetype. +
_Inherited from xref:{class_p_archetype}[P_ARCHETYPE]_

|*archetype_id*: `xref:{class_p_archetype_hrid}[P_ARCHETYPE_HRID]` [1..1]
...
|*definition*: `xref:{class_p_c_complex_object}[P_C_COMPLEX_OBJECT]` [1..1]
a|Root node of the definition of this archetype. +
_Inherited from xref:{class_p_archetype}[P_ARCHETYPE]_

|*terminology*: `xref:{class_p_archetype_terminology}[P_ARCHETYPE_TERMINOLOGY]` [1..1]
...
_Inherited from xref:{class_p_authored_resource}[P_AUTHORED_RESOURCE]_
...
_Inherited from xref:{class_p_authored_archetype}[P_AUTHORED_ARCHETYPE]_

|*build_uid*: `xref:{class_uid}[UID]` [1..1]
...
|*component_terminologies*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_p_archetype_terminology}[P_ARCHETYPE_TERMINOLOGY]>` [0..1]
...
|*terminology_extracts*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_archetype_term}[ARCHETYPE_TERM]>>` [0..1]
