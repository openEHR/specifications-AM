...
2+|Inherits: xref:AM:p_aom2:constraint_model_package.adoc#_p_archetype_constraint_class[P_ARCHETYPE_CONSTRAINT]
...
|*children*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:AM:p_aom2:constraint_model_package.adoc#_p_c_object_class[P_C_OBJECT]>` [0..1]
