...
2+|Inherits: xref:AM:p_aom2:archetype_package.adoc#_p_archetype_class[P_ARCHETYPE], xref:BASE:resource:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE], xref:AM:p_aom2:archetype_package.adoc#_p_authored_resource_class[P_AUTHORED_RESOURCE]
...
_Inherited from xref:AM:p_aom2:archetype_package.adoc#_p_archetype_class[P_ARCHETYPE]_

|*archetype_id*: `xref:AM:p_aom2:archetype_package.adoc#_p_archetype_hrid_class[P_ARCHETYPE_HRID]` [1..1]
...
|*definition*: `xref:AM:p_aom2:constraint_model_package.adoc#_p_c_complex_object_class[P_C_COMPLEX_OBJECT]` [1..1]
a|Root node of the definition of this archetype. +
_Inherited from xref:AM:p_aom2:archetype_package.adoc#_p_archetype_class[P_ARCHETYPE]_

|*terminology*: `xref:AM:p_aom2:terminology_package.adoc#_p_archetype_terminology_class[P_ARCHETYPE_TERMINOLOGY]` [1..1]
...
_Inherited from xref:AM:p_aom2:archetype_package.adoc#_p_authored_resource_class[P_AUTHORED_RESOURCE]_
