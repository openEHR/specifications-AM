...
2+|Inherits: xref:AM:AOM2:archetype_package.adoc#_archetype_class[ARCHETYPE], xref:BASE:resource:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE]
