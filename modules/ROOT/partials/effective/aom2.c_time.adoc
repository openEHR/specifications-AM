...
|*default_value*: `xref:{class_iso8601_time}[Iso8601_time]` [0..1]
...
|*constraint*: `xref:{class_list}[List]<xref:{class_interval}[Interval]<xref:{class_iso8601_time}[Iso8601_time]>>` [0..1]
