...
|*default_value*: `xref:{class_iso8601_duration}[Iso8601_duration]` [0..1]
...
|*constraint*: `xref:{class_list}[List]<xref:{class_interval}[Interval]<xref:{class_iso8601_duration}[Iso8601_duration]>>` [0..1]
