...
|*default_value*: `xref:BASE:foundation_types:primitive_types.adoc#_real_class[Real]` [0..1]
...
|*constraint*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:interval.adoc#_interval_class[Interval]<xref:BASE:foundation_types:primitive_types.adoc#_real_class[Real]>>` [0..1]
