...
2+|Inherits: xref:{class_adl_code_definitions}[ADL_CODE_DEFINITIONS], xref:{class_archetype_constraint}[ARCHETYPE_CONSTRAINT], xref:{class_c_object}[C_OBJECT], xref:{class_c_defined_object}[C_DEFINED_OBJECT], xref:{class_c_primitive_object}[C_PRIMITIVE_OBJECT], xref:{class_c_ordered}[C_ORDERED], xref:{class_c_temporal}[C_TEMPORAL]
...
|*default_value*: `xref:{class_iso8601_date_time}[Iso8601_date_time]` [0..1]
...
_Inherited from xref:{class_c_primitive_object}[C_PRIMITIVE_OBJECT]_

|*constraint*: `xref:{class_list}[List]<xref:{class_interval}[Interval]<xref:{class_iso8601_date_time}[Iso8601_date_time]>>` [0..1]
...
|*c_conforms_to* ( +
other: `xref:{class_c_primitive_object}[C_PRIMITIVE_OBJECT][1]`, +
...
|*constrained_typename* (): `xref:{class_string}[String]` [1..1]
...
|*month_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]` [1..1]
a|Validity of month in constrained date.

|*day_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]` [1..1]
a|Validity of day in constrained date.

|*minute_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]` [1..1]
a|Validity of minute in constrained time.

|*second_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]` [1..1]
a|Validity of second in constrained time.

|*millisecond_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]` [1..1]
a|Validity of millisecond in constrained time.

|*timezone_validity* (): `xref:{class_validity_kind}[VALIDITY_KIND]` [1..1]
