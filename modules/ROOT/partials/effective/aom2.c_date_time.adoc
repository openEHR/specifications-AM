...
|*At_code_leader*: `xref:{class_string}[String]{nbsp}={nbsp}"at"` [1..1]
...
|*Root_code_regex_pattern*: `xref:{class_string}[String]{nbsp}={nbsp}"^(id1&#124;at0000)(\.1)&#42;$"` [1..1]
...
|*Primitive_node_id*: `xref:{class_string}[String]{nbsp}={nbsp}"at9999"` [1..1]
...
|*alternative_ids*: `xref:{class_list}[List]<xref:{class_string}[String]>` [0..1]
