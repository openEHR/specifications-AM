...
|*default_value*: `xref:BASE:foundation_types:time_types.adoc#_iso8601_date_time_class[Iso8601_date_time]` [0..1]
...
_Inherited from xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_primitive_object_class[C_PRIMITIVE_OBJECT]_

|*constraint*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:interval.adoc#_interval_class[Interval]<xref:BASE:foundation_types:time_types.adoc#_iso8601_date_time_class[Iso8601_date_time]>>` [0..1]
...
_Inherited from xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_temporal_class[C_TEMPORAL]_
...
|*c_value_conforms_to* ( +
other: `xref:AM:AOM2:constraint_model-class_definitions.adoc#_c_ordered_class[C_ORDERED][1]` +
): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
...
|*month_validity* (): `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]` [1..1]
a|Validity of month in constrained date.

|*day_validity* (): `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]` [1..1]
a|Validity of day in constrained date.

|*minute_validity* (): `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]` [1..1]
a|Validity of minute in constrained time.

|*second_validity* (): `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]` [1..1]
a|Validity of second in constrained time.

|*millisecond_validity* (): `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]` [1..1]
a|Validity of millisecond in constrained time.

|*timezone_validity* (): `xref:BASE:base_types:definitions_package.adoc#_validity_kind_enumeration[VALIDITY_KIND]` [1..1]
