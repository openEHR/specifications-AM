...
include::ROOT:partial$classes/aom2.version_status.adoc[]

include::ROOT:partial$classes/aom2.validity_kind.adoc[]

include::ROOT:partial$classes/aom2.adl_code_definitions.adoc[]
