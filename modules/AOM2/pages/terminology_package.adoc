...
[.text-center]
.Terminology Package
image::{uml_export_dir}/diagrams/AOM-terminology.svg[id=terminology_package, align="center"]
...
include::ROOT:partial$classes/aom2.archetype_terminology.adoc[]
include::ROOT:partial$classes/aom2.terminology_relation.adoc[]
include::ROOT:partial$classes/aom2.value_set.adoc[]
include::ROOT:partial$classes/aom2.archetype_term.adoc[]
