...
image::ROOT:uml/AM-aom2.terminology.svg[id=terminology_package, align="center"]
...
image::diagrams/terminology_instance_structure.svg[id=terminology_instance, align="center"]
