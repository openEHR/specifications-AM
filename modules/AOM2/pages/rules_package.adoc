...
image::ROOT:uml/AM-aom2.rules.svg[id=rules_package, align="center"]
...
include::ROOT:partial$classes/aom2.expr_constraint.adoc[]
include::ROOT:partial$classes/aom2.expr_archetype_id_constraint.adoc[]
include::ROOT:partial$classes/aom2.expr_archetype_ref.adoc[]