...
include::ROOT:partial$classes/aom2.aom_profile.adoc[]
include::ROOT:partial$classes/aom2.aom_type_mapping.adoc[]
include::ROOT:partial$classes/aom2.aom_property_mapping.adoc[]
