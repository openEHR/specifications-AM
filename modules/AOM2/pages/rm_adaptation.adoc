...
image::ROOT:uml/AM-aom2.profile.svg[id=aom_profile, align="center"]

=== Class Definitions

include::ROOT:partial$classes/aom2.aom_profile.adoc[leveloffset=+1]
include::ROOT:partial$classes/aom2.aom_type_mapping.adoc[leveloffset=+1]
include::ROOT:partial$classes/aom2.aom_property_mapping.adoc[leveloffset=+1]
