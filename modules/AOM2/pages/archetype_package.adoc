...
[.text-center]
.Governance Meta-data
image::metadata_governance.png[id=metadata_governance, align="center", width="80%"]
...
[.text-center]
.Authoring Meta-data
image::metadata_authoring.png[id=metadata_authoring, align="center", width="90%"]
...
[.text-center]
.Descriptive Meta-data
image::metadata_details.png[id=metadata_descriptive, align="center"]
...
image::ROOT:uml/AM-source_archetype_structure.svg[id=source_archetype_structure, align="center", width="60%"]
...
image::ROOT:uml/AM-source_template_structure.svg[id=source_template_structure, align="center", width="80%"]
...
image::ROOT:uml/AM-operational_template_structure.svg[id=operational_template_structure, align="center", width="80%"]
