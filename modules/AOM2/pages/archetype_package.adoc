...
[.text-center]
.Archetype Package
image::{uml_export_dir}/diagrams/AOM-archetype.svg[id=archetype_package, align="center"]
...
image::{uml_export_dir}/diagrams/AOM-source_archetype_structure.svg[id=source_archetype_structure, align="center", width="60%"]
...
image::{uml_export_dir}/diagrams/AOM-source_template_structure.svg[id=source_template_structure, align="center", width="80%"]
...
image::{uml_export_dir}/diagrams/AOM-operational_template_structure.svg[id=operational_template_structure, align="center", width="80%"]

More details of template development, representation and semantics are described in the next section.

== Class Descriptions

include::ROOT:partial$classes/aom2.authored_resource.adoc[]
include::ROOT:partial$classes/aom2.resource_description.adoc[]
include::ROOT:partial$classes/aom2.resource_description_item.adoc[]
include::ROOT:partial$classes/aom2.resource_annotations.adoc[]
include::ROOT:partial$classes/aom2.translation_details.adoc[]
include::ROOT:partial$classes/aom2.archetype.adoc[]
include::ROOT:partial$classes/aom2.authored_archetype.adoc[]
include::ROOT:partial$classes/aom2.archetype_hrid.adoc[]
include::ROOT:partial$classes/aom2.template.adoc[]
include::ROOT:partial$classes/aom2.template_overlay.adoc[]
include::ROOT:partial$classes/aom2.operational_template.adoc[]
...
[.rule]
*VARCN*: archetype concept validity. The `_node_id_` of the root object of the archetype must be of the form `id1{.1}*`, where the number of `.1` components equals the specalisation depth, and must be defined in the terminology.
