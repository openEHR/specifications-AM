...
[.text-center]
.`rm_overlay` package
image::ROOT:uml/AM-aom2.rm_overlay.svg[id=rm_overlay_package, align="center"]
...
include::ROOT:partial$classes/aom2.rm_overlay.adoc[]
include::ROOT:partial$classes/aom2.rm_attribute_visibility.adoc[]
include::ROOT:partial$classes/aom2.visibility_type.adoc[]
