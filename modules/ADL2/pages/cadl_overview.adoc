...
include::partial$cadl_basics.adoc[leveloffset=+1]

include::partial$cadl_complex_types.adoc[leveloffset=+1]

include::partial$cadl_second_order.adoc[leveloffset=+1]

include::partial$cadl_primitive_types.adoc[leveloffset=+1]

include::partial$cadl_validity_rules.adoc[leveloffset=+1]
