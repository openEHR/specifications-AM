...
[.text-center]
.UML Model of Person
image::ROOT:uml/AM-example-demographics.svg[id=uml_model_of_person, align="center"]
...
image::ROOT:uml/AM-example-demographics-parties.svg[id=ADL-demographics-parties, align="center"]
