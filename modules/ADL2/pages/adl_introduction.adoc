...
include::partial$adl_conventions.adoc[leveloffset=+1]

include::partial$adl_artefacts.adoc[leveloffset=+1]

include::partial$adl_basics.adoc[leveloffset=+1]

include::partial$adl_identification.adoc[leveloffset=+1]

include::partial$adl_specialise.adoc[leveloffset=+1]

include::partial$adl_language.adoc[leveloffset=+1]

include::partial$adl_description.adoc[leveloffset=+1]

include::partial$adl_deprecated.adoc[leveloffset=+1]

include::partial$adl_definition.adoc[leveloffset=+1]

include::partial$adl_rules.adoc[leveloffset=+1]

include::partial$adl_rm_overlay.adoc[leveloffset=+1]

include::partial$adl_terminology.adoc[leveloffset=+1]

include::partial$adl_annotations.adoc[leveloffset=+1]
