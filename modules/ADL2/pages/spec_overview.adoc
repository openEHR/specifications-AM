...
include::partial$spec_concepts.adoc[leveloffset=+1]

include::partial$spec_examples.adoc[leveloffset=+1]

include::partial$spec_attrib_redef.adoc[leveloffset=+1]

include::partial$spec_object_redef.adoc[leveloffset=+1]

include::partial$spec_rules.adoc[leveloffset=+1]

include::partial$spec_languages.adoc[leveloffset=+1]

include::partial$spec_description.adoc[leveloffset=+1]

include::partial$spec_terminology.adoc[leveloffset=+1]

include::partial$spec_bindings.adoc[leveloffset=+1]
