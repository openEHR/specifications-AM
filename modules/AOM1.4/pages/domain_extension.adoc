...
image::ROOT:uml/AM-aom14.openehr_archetype_profile.svg[id=example_domain_package, align="center"]


== Class Descriptions

include::ROOT:partial$classes/aom14.c_ordinal.adoc[]
include::ROOT:partial$classes/aom14.ordinal.adoc[]
include::ROOT:partial$classes/aom14.c_quantity.adoc[]
include::ROOT:partial$classes/aom14.c_quantity_item.adoc[]
include::ROOT:partial$classes/aom14.c_coded_text.adoc[]