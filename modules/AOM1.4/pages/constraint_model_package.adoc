...
image::ROOT:uml/AM-constraint_model.svg[id=constraint_model_package, align="center"]
...
image::diagrams/c_attributes_single_multiple.png[id=c_attributes_single_multiple, align="center", width="70%"]
...
include::ROOT:partial$classes/aom14.archetype_constraint.adoc[]
include::ROOT:partial$classes/aom14.c_attribute.adoc[]
include::ROOT:partial$classes/aom14.c_single_attribute.adoc[]
include::ROOT:partial$classes/aom14.c_multiple_attribute.adoc[]
include::ROOT:partial$classes/aom14.cardinality.adoc[]
include::ROOT:partial$classes/aom14.c_object.adoc[]
include::ROOT:partial$classes/aom14.c_defined_object.adoc[]
include::ROOT:partial$classes/aom14.c_complex_object.adoc[]
include::ROOT:partial$classes/aom14.c_primitive_object.adoc[]
include::ROOT:partial$classes/aom14.c_domain_type.adoc[]
include::ROOT:partial$classes/aom14.c_reference_object.adoc[]
include::ROOT:partial$classes/aom14.archetype_slot.adoc[]
include::ROOT:partial$classes/aom14.archetype_internal_ref.adoc[]
include::ROOT:partial$classes/aom14.constraint_ref.adoc[]
