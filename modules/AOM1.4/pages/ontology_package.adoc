...
image::ROOT:uml/AM-ontology.svg[id=ontology_package, align="center"]
...
include::ROOT:partial$classes/aom14.archetype_ontology.adoc[]
include::ROOT:partial$classes/aom14.archetype_term.adoc[]
