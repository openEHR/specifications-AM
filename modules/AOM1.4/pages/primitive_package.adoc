...
image::ROOT:uml/AM-constraint_model.primitive.svg[id=constraint_model.primitive_package, align="center"]
...
include::ROOT:partial$classes/aom14.c_primitive.adoc[]
include::ROOT:partial$classes/aom14.c_boolean.adoc[]
include::ROOT:partial$classes/aom14.c_string.adoc[]
include::ROOT:partial$classes/aom14.c_integer.adoc[]
include::ROOT:partial$classes/aom14.c_real.adoc[]
include::ROOT:partial$classes/aom14.c_date.adoc[]
include::ROOT:partial$classes/aom14.c_time.adoc[]
include::ROOT:partial$classes/aom14.c_date_time.adoc[]
include::ROOT:partial$classes/aom14.c_duration.adoc[]
