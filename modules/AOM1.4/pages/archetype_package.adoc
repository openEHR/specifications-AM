...
image::{uml_export_dir}/AOM1.4/diagrams/AOM-archetype.svg[id=archetype_package, align="center"]
...
include::ROOT:partial$classes/aom14.archetype.adoc[]
include::ROOT:partial$classes/aom14.validity_kind.adoc[]
